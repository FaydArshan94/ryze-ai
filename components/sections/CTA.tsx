...
export default function FinalCTA() {
  ...
  return (
    <section className="relative bg-slate-950 py-20 sm:py-24 lg:py-32 overflow-hidden">
      {/* Background Effects */}
        ...
        <div className="text-center space-y-8">
          ...
          <div className="pt-4">
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-10 py-5 bg-linear-to-r from-blue-600 to-cyan-600 rounded-xl font-bold text-lg text-white shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300"
            >
