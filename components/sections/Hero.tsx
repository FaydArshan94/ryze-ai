...
import { ArrowRight, Sparkles, MessageSquare, TrendingUp, Zap, Play } from 'lucide-react';
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-blue-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-32 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="space-y-8 xl:space-y-6 text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center hover:-rotate-2 transition-transform duration-200 gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
              <Sparkles className="w-4 h-4 text-blue-400" />
              <span className="text-sm font-medium text-blue-300">AI-Powered Lead Generation</span>
            </div>

            {/* Headline */}
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl xl:leading-tighter font-bold leading-tight">
              ...
              <p className="text-lg sm:text-xl text-slate-300 max-w-xl mx-auto lg:mx-0">
                Ryze AI helps you capture, qualify, and convert visitors automatically — 24/7.
              </p>
            </div>
            ...
            <div className="flex flex-col  sm:flex-row gap-4 justify-center lg:justify-start">
              <button className="group relative px-8 py-4 bg-linear-to-r from-blue-600 to-cyan-600 rounded-lg font-semibold text-white shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105">
            ...
            <div className="pt-8">
              ...
              <div className="flex flex-wrap gap-8 items-center justify-center lg:justify-start opacity-60">
                <div className="text-slate-400 font-semibold text-lg">Google Ads</div>
                <div className="text-slate-400 font-semibold text-lg">DTC Brands</div>
                <div className="text-slate-400 font-semibold text-lg">Agencies</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative z-10 bg-linear-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-6 sm:p-8">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                ...
                <div>
                  <h3 className="text-white font-semibold">Ryze AI Assistant</h3>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 max-w-[80%] border border-white/10">
                    <p className="text-sm text-slate-200">
                      Hey! 👋 Looking to boost your conversions? I can help you qualify leads instantly.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 max-w-[80%] border border-white/10">
                    <p className="text-sm text-slate-200 mb-3">
                      I engage visitors, ask the right questions, and book qualified demos automatically.
                    </p>
