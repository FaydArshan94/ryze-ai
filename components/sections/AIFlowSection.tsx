...
import { Sparkles, TrendingUp, Target, Database, CheckCircle } from 'lucide-react';
...
export default function AIFlowSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Smart questions identify high-value prospects automatically.',
      icon: Target,
  ...
  const chatMessages = [
    { type: 'ai', text: "Hi! 👋 I'm here to help. What brings you to our site today?", step: 0 },
    { type: 'user', text: "I'm looking for a solution to capture more leads from my website.", step: 1 },
    { type: 'ai', text: "Great! I can help with that. What's your current monthly website traffic?", step: 2 },
    { type: 'user', text: "Around 10,000 visitors per month.", step: 2 },
    { type: 'ai', text: "Perfect! And what's your biggest challenge with lead generation right now?", step: 3 },
    { type: 'user', text: "Most visitors leave without taking any action.", step: 3 },
    { type: 'ai', text: "I understand. Based on your needs, I'd recommend booking a personalized demo. Would Tuesday or Wednesday work better for you?", step: 3 },
    { type: 'user', text: "Tuesday works great!", step: 3 },
    { type: 'ai', text: "✅ Perfect! I've captured your information and a demo specialist will reach out shortly. Check your email for confirmation.", step: 4, highlight: true }
  ];
          ...
          if (entry.isIntersecting) {
            ...
            const interval = setInterval(() => {
              if (currentStep < steps.length) {
                ...
                const messagesForStep = chatMessages.filter(msg => msg.step <= currentStep);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-400">
            Watch how our AI transforms visitors into qualified leads in real-time.
          </p>
        </div>
          ...
          <div className="space-y-6">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className={`flex gap-4 p-6 rounded-xl border transition-all duration-500 ${
                    isCurrent 
                      ? 'bg-slate-800/80 border-blue-500/50 shadow-lg shadow-blue-500/20' 
                      : 'bg-slate-800/40 border-slate-700/50'
                  }`}>
                    {/* Icon */}
                    <div className={`shrink-0 w-12 h-12 rounded-lg bg-linear-to-br ${step.color} flex items-center justify-center transition-transform duration-500 ${
            ...
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-6 py-4 bg-slate-800/80 border-b border-slate-700/50">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Online • Instant Reply</p>
                </div>
              </div>
              ...
              <div className="p-6 space-y-4 h-125 overflow-y-auto">
                {visibleMessages.map((message, index) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      } ${message.type === 'ai' ? 'rounded-tl-none' : 'rounded-tr-none'}`}
                    >
                ...
                {/* Typing Indicator */}
                {activeStep < steps.length - 1 && visibleMessages.length > 0 && (
